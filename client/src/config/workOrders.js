export const WORK_ORDER_TABS = [
  { id: 'received', label: 'Received', segment: 'work-orders/received', countKey: 'received' },
  { id: 'assigned', label: 'Assigned', segment: 'work-orders/assigned', countKey: 'assigned' },
  { id: 'scheduled', label: 'Scheduled', segment: 'work-orders/scheduled', countKey: 'scheduled' },
  { id: 'manual', label: 'Manual', segment: 'work-orders/manual', countKey: 'manual' },
]
